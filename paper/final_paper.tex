...
\begin{itemize}
    ...
    \item \textbf{A competitive single-task DistilBERT baseline on CONDA.} Trained on intent labels only, our model reaches macro-F1 0.838 / UCA 0.915 on the validation set, within $\sim$0.6 UCA points of CONDA's dual-task JointBERT baseline despite the absence of slot-level supervision.
